...
def test_dynamic_zones(img_path):
    print(f"\n--- Analyzing {img_path} ---")
    ...
    for cnt in contours:
        ...
        # Lowered min area from 80000 to 15000
        if 15000 < w * h < 2500000:
    ...
    for b in boxes:
        x, y, w, h = b
        if w > 2000 or h < 80: # lowered min height from 200 to 80
            continue
